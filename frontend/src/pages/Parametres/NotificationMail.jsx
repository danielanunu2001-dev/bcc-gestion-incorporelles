...
import { 
  ...
  FiServer, FiDatabase, FiZap, FiSettings, FiInfo
} from 'react-icons/fi';
        ...
        <div style={styles.container}>
          ...
          {saveStatus && (
            <div style={saveStatus.success ? styles.successMessage : styles.errorMessage}>
              ...
              <span style={{ color: saveStatus.success ? '#065f46' : '#991b1b' }}>{saveStatus.message}</span>
            </div>
          )}
          {testStatus && (
            <div style={testStatus.type === 'success' ? styles.successMessage : 
              ...
              {testStatus.type === 'sending' && <FiRefreshCw size={20} className="spin-animation" />}
              <span style={{ color: testStatus.type === 'success' ? '#065f46' : testStatus.type === 'error' ? '#991b1b' : '#075985' }}>
                {testStatus.message}
              </span>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            {activeTab === 'notifications' && (
              <div style={styles.section}>
                ...
                <div style={styles.infoBox}>
                  ...
                  <small style={{ color: '#000000' }}>Les notifications critiques sont envoyées immédiatement, les autres peuvent être regroupées</small>
                </div>
              </div>
            )}
            ...
            {activeTab === 'destinataires' && (
              <div style={styles.section}>
                ...
                <div style={styles.infoBox}>
                  <FiInfo size={16} color="#3b82f6" />
                  <small style={{ color: '#000000' }}>Ces adresses recevront les notifications selon leur niveau de priorité</small>
                </div>
              </div>
            )}
            ...
            {activeTab === 'rapports' && (
              <div style={styles.section}>
                ...
                <div style={styles.infoBox}>
                  <FiInfo size={16} color="#3b82f6" />
                  <small style={{ color: '#000000' }}>Les rapports sont envoyés à 8h00 le matin pour la période correspondante</small>
                </div>
              </div>
            )}
            ...
            <div style={styles.actions}>
              <button type="submit" style={styles.saveButton} disabled={loading}>
                {loading ? <FiRefreshCw className="spin-animation" /> : <FiSave />}
          ...
          <div style={styles.footer}>
            <small style={styles.footerText}>
              <FiShield size={12} /> Configuration sécurisée - BCC
            </small>
          </div>
        </div>
      </div>
...
const styles = {
  ...
  infoMessage: { display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '1rem', backgroundColor: '#e0f2fe', border: '1px solid #3b82f6', borderRadius: '10px', marginBottom: '1.5rem', fontSize: '0.875rem' },
  ...
  sectionTitle: { fontSize: '1rem', fontWeight: '600', color: '#000000', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' },
  sectionIcon: { color: '#10b981' },
  formGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' },
  formGroup: { marginBottom: '1rem' },
  label: { display: 'block', marginBottom: '0.5rem', fontSize: '0.75rem', fontWeight: '500', color: '#000000' },
  input: { width: '100%', padding: '0.625rem', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '0.875rem', color: '#000000', backgroundColor: 'white' },
  select: { width: '100%', padding: '0.625rem', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '0.875rem', backgroundColor: 'white', color: '#000000' },
  checkboxGroup: { display: 'flex', gap: '1.5rem', marginTop: '1rem', flexWrap: 'wrap' },
  checkboxLabel: { display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', fontSize: '0.875rem', color: '#000000' },
  notificationGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(250px, 1fr))', gap: '0.75rem' },
  notificationLabel: { display: 'flex', alignItems: 'center', gap: '0.5rem', cursor: 'pointer', fontSize: '0.875rem', color: '#000000', padding: '0.5rem', backgroundColor: '#f8fafc', borderRadius: '8px' },
