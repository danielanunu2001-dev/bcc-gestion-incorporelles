...
const NotificationMailBCC = () => {
  ...
  const handleTest = () => {
    ...
    setTimeout(() => {
      // Simulation d'envoi
      const success = Math.random() > 0.2; // 80% de succès pour la simulation
      if (success) {
      ...
      <form onSubmit={handleSubmit} style={styles.form}>
        ...
        <div style={styles.section}>
          <h3 style={styles.sectionTitle}>
            <FiMail style={styles.sectionIcon} /> Serveur SMTP
          </h3>
        ...
        <div style={styles.section}>
          ...
          <div style={styles.notificationGrid}>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.connexion_anormale}
                onChange={() => handleNotificationChange('connexion_anormale')}
              />
              <FiAlertCircle size={14} /> Connexions anormales
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.modification_critique}
                onChange={() => handleNotificationChange('modification_critique')}
              />
              <FiFileText size={14} /> Modifications critiques
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.cloture_exercice}
                onChange={() => handleNotificationChange('cloture_exercice')}
              />
              <FiClock size={14} /> Clôture d'exercice
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.operation_monetaire}
                onChange={() => handleNotificationChange('operation_monetaire')}
              />
              <FiTrendingUp size={14} /> Opérations monétaires
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.reserves_change}
                onChange={() => handleNotificationChange('reserves_change')}
              />
              <FiGlobe size={14} /> Réserves de change
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.rapport_politique}
                onChange={() => handleNotificationChange('rapport_politique')}
              />
              <FiFileText size={14} /> Rapports politique monétaire
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.alerte_securite}
                onChange={() => handleNotificationChange('alerte_securite')}
              />
              <FiShield size={14} /> Alertes de sécurité
            </label>
            <label style={styles.notificationLabel}>
              <input
                type="checkbox"
                checked={config.notifications.nouveau_utilisateur}
                onChange={() => handleNotificationChange('nouveau_utilisateur')}
              />
              <FiUsers size={14} /> Nouveaux utilisateurs
            </label>
          </div>
        </div>
        ...
        {/* Paramètres avancés */}
        <div style={styles.section}>
          <h3 style={styles.sectionTitle}>Paramètres avancés</h3>
          <div style={styles.formGrid}>
            <div style={styles.formGroup}>
            ...
            <div style={styles.formGroup}>
              <label style={styles.label}>Tentatives de réessai</label>
              <input
                type="number"
                name="retry_count"
          ...
          <div style={styles.checkboxGroup}>
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                name="notifications_actives"
                checked={config.notifications_actives}
                onChange={handleChange}
              />
        ...
        {/* Rapports planifiés */}
        <div style={styles.section}>
          <h3 style={styles.sectionTitle}>Rapports planifiés</h3>
          <div style={styles.checkboxGroup}>
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                checked={config.rapports_planifies.quotidien}
                onChange={(e) => setConfig({
                  ...config,
            ...
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                checked={config.rapports_planifies.hebdomadaire}
                onChange={(e) => setConfig({
                  ...config,
            ...
            <label style={styles.checkboxLabel}>
              <input
                type="checkbox"
                checked={config.rapports_planifies.mensuel}
                onChange={(e) => setConfig({
                  ...config,
